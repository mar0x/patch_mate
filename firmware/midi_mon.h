...
inline void
midi_mon_t::setup(unsigned long t) {
    active_ = true;
    visible_ = false;
...
inline void
midi_mon_t::set_mode(uint8_t mode) {
    if (mode_ == mode) {
        return;
    }
...
inline uint8_t
midi_mon_t::render(char *dst, uint8_t pos, bool &sep) const {
    uint8_t b = data_[pos];
...
inline bool
midi_mon_t::toggle_pause(unsigned long t) {
...
inline void
midi_mon_t::update(unsigned long t) {
...
inline void
midi_mon_t::scroll_up(unsigned long) {
...
inline void
midi_mon_t::scroll_down(unsigned long) {
...
inline void
midi_mon_t::mode(uint8_t m, unsigned long) {
    set_mode( m % MODE_MAX );
}

inline void
midi_mon_t::mode_next(unsigned long) {
    set_mode( (mode_ + 1) % MODE_MAX );
}

inline void
midi_mon_t::mode_prev(unsigned long) {
